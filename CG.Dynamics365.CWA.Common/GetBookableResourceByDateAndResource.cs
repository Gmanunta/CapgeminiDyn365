...
{
    public class GetBookableResourceByDateAndResource : CodeActivity
    {
        [Input("start")]
        [ArgumentRequired]
        ...
        [Output("hasbookableresourcebooking")]
        public OutArgument<Boolean> HasBookableResourceBooking { get; set; }
        ...
        protected override void Execute(CodeActivityContext executionContext)
        {
            ...
            try
            {
                ...
                if (results.Entities.Count > 0)
                {
                    ...
                    HasBookableResourceBooking.Set(executionContext, true);
                }
                else
                {
                    err += "33";
                    HasBookableResourceBooking.Set(executionContext, false);
                }
